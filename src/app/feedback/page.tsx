    ...
    <div className="min-h-dvh bg-slate-50">
      ...
      <header className="bg-blue-600 px-4 py-6 text-white">
        <div className="mx-auto max-w-lg text-center">
          ...
          <h1 className="text-xl font-bold">E-Logbook Chirurgical</h1>
      ...
      <div className="mx-auto max-w-lg px-4 py-6">
        <div className="mb-4 rounded-xl bg-blue-50 p-4 text-sm text-blue-800">
          ...
          <p className="mt-1">
            Merci de tester E-Logbook ! Vos retours sont essentiels pour améliorer
            cette application destinée au suivi des compétences chirurgicales des étudiants DES.
          </p>
        ...
        <p className="mt-6 text-center text-xs text-slate-400">
          E-Logbook Chirurgical — CNHU-HKM Bénin
        </p>
      </div>
    </div>
  )
